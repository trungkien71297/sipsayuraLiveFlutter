...
class _MainViewState extends State<MainView> with WidgetsBindingObserver {
  ...
  late StreamSubscription _videoConnectionsStreamSubscription;

  /// Subscription to screenshare connection list changes.
  late StreamSubscription _screenshareVideoConnectionsStreamSubscription;

  /// Subscription to unread message counter updates.
  late StreamSubscription<UnreadMessageCounterEvent>
      _unreadMessageCounterStreamSubscription;

  /// Subscription to incoming poll events.
  late StreamSubscription<Poll> _pollStreamSubscription;

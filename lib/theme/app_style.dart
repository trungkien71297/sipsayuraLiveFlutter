...
class AppStyle {
  ...
  static TextStyle textstylemontserratmedium13 = TextStyle(
  ...
  static TextStyle textstylenunitoregular12 = TextStyle(
  ...
  static TextStyle textstylemontserratlight11 = TextStyle(
  ...
  static TextStyle textstylenunitosemibold93 = TextStyle(
    color: Colors.white,
    fontSize: getFontSize(
      9,
    ),
  ...
  static TextStyle textstylemontserratextralight8 = TextStyle(
    color: ColorConstant.bluegray900,
    fontSize: getFontSize(
      8,
    ),
  ...
  static TextStyle textstylemontserratbold6 = TextStyle(
    color: ColorConstant.bluegray900,
    fontSize: getFontSize(
      6,
    ),
  ...
  static TextStyle textstylenunitolight10 = TextStyle(
    color: ColorConstant.black900,
    fontSize: getFontSize(
      10,
    ),
  ...
  static TextStyle textstylemontserratextralight10 = TextStyle(
    color: ColorConstant.black900,
    fontSize: getFontSize(
      10,
    ),
  ...
  static TextStyle textstylemontserratromanbold11 = TextStyle(
    color: ColorConstant.whiteA700,
    fontSize: getFontSize(
      11,
    ),
  ...
  static TextStyle textstylenunitobold91 = textstylenunitobold92.copyWith();

  static TextStyle textstylemontserratromanbold8 = TextStyle(
    color: ColorConstant.black900,
    fontSize: getFontSize(
      8,
    ),
  ...
  static TextStyle textstylenunitobold92 = textstylenunitobold9.copyWith(
    color: ColorConstant.black900,
  );
  ...
  static TextStyle textstylenunitobold9 = TextStyle(
    color: ColorConstant.gray500,
    fontSize: getFontSize(
      9,
    ),

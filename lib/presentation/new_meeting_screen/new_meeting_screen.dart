                          ...
                          children: [
                            Padding(
                                padding: EdgeInsets.only(
                                    left: getHorizontalSize(44.75),
                                    top: getVerticalSize(32.50),
                                    right: getHorizontalSize(38.75)),
                                child: Text("my_meetinga_id".tr,
                                    overflow: TextOverflow.ellipsis,
                                    textAlign: TextAlign.left,
                                    style: AppStyle.textstylemontserratlight11
                                  ...
                                  child: Row(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Text("lbl_937_964_8755".tr,
                                              overflow: TextOverflow.ellipsis,
                                        ...
                                        Padding(
                                            padding: EdgeInsets.only(
                                                ...
                                                bottom: getVerticalSize(6.75)),
                                            child: Container(
                                              height: getVerticalSize(16.50),
                                              width: getHorizontalSize(5.25),
                                              child: Icon(
                                                Icons.copy_outlined,
